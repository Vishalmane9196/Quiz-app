...
const App = (() => {
  ...
  //change inner html for current question
  ...
  // 2. to render choices automatically
  ...
  //3. render  tracker like 1 out of 5
...
//4. progress bar 
  ...
  //render question or end end screen
  const renderAll = _ => {
    if (quiz.hasEnded()) {
      // renderEndScreen
      renderEndScreen();
...
//revealing module pattern (design pattern) --> using IEFE